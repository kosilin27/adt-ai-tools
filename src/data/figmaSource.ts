...
export function validateSourceSnapshot(){
  if(TOOL_NODE_IDS.length!==87||new Set(TOOL_NODE_IDS).size!==87) throw new Error('Figma tool snapshot must contain 87 unique node IDs');
